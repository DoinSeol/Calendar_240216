...
function buildCalendar() {
  ...
  for(let day = 1 - doMonth.getDay(); daysLength >= day; day++) {
      ...
      if(Math.sign(day) == 1 && lastDate.getDate() >= day) {
        ...
        let days = autoLeftPad(day, 2);
        column.innerHTML = "<div class='days_box'><span>"+ days+"</span></div><div class='status_box'></div>";
            ...
            if(dom % 7 == 3 || dom % 7 == 5) {
                ...
                column.innerHTML = "<div class='days_box'><span>"+ days+"</span></div><div class='status_box'><ul><li><span class='sta_0'>10:00</span></li><li>"+sta_0+"</li></ul><ul><li><span class='sta_01'>11:00</span></li><li>"+sta_1+"</li></ul></div>";
            }
      ...
      // @param 평일 전월일과 익월일의 데이터 날짜변경
        ...
        let days_over = autoLeftPad(exceptDay.getDate(), 2);
        column.innerHTML = "<div class='days_box'><span>"+ days_over+"</span></div><div class='status_box'></div>";
